  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      ctx.effect(() => {
        ...
        tag.textContent = [
          '.zai-restart-dsh{flex:1 1 0;min-width:0;width:auto;align-items:center;justify-content:flex-start;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:transparent;border:none;border-radius:12px;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden;position:relative}',
          ...
          '.zai-restart-dsh--rail{width:36px;height:36px;border-radius:50%;justify-content:center;gap:0;padding:0;flex:none}',
