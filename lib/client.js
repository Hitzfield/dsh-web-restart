 ...
 * POSTs /restart-dsh (no confirmation step).
 */
  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      ctx.effect(() => {
        ...
        tag.textContent = [
          '.zai-restart-dsh{flex:none;align-items:center;width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:transparent;border:none;border-radius:12px;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}',
